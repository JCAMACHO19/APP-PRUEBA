...
if st.button('Procesar Archivos'):
    if dian_file and sinco_file and cuentas_file:
        ...
        try:
            ...
            process = subprocess.Popen([sys.executable, os.path.join(UPLOAD_FOLDER,"codes_proceso_completo",'ejecutar.py'), dian_path, sinco_path, cuentas_path], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
