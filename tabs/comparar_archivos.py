    ...
    if st.button('Comparar Archivos'):
        if dian_file and sinco_file:
            ...
            try:
                ...
                process = subprocess.Popen([sys.executable, os.path.join(subfolder, "codes_proceso_completo", 'ejecutar_comparativ.py'), dian_path, sinco_path], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
